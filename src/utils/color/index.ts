/*
 *
 * https://github.com/ionic-team/ionic-docs/blob/203a25fc8636e8ced0b44a1f417d2783a33a31f8/src/components/color-gen/color.ts
 *
 * */
...
export class Color {
  ...
  constructor(value: string | RGB | HSL) {
    ...
    if (typeof value === 'string') {
      ...
      this.rgbString = rgbToRGBString(this.rgb);
